...
Anda tahu [semua](https://twitter.com/dan_abramov/status/890191815567175680) [dari](https://twitter.com/reactjs/status/890511993261654017) [tangkapan layar kode](https://twitter.com/notquiteleo/status/873483329345028096) yang Anda lihat di Twitter? Meskipun kodenya biasanya mengesankan, kami melihat ruang untuk perbaikan di departemen estetika. Karbon memudahkan untuk membuat dan berbagi gambar indah dari kode sumber Anda. Jadi tunggu apa lagi? Buat semua pengikut Anda terkesan dengan kecakapan desain yang baru Anda temukan.
...
- **Kustomisasi**. Sesuaikan hal-hal seperti tema sintaks gambar Anda, gaya font, dan banyak lagi
- **Bagikan dengan cepat**. Simpan gambar Anda atau tautan dengan satu klik
- **Simpan cuplikan**. Buat akun untuk menyimpan cuplikan untuk nanti. Cuplikan yang dibagikan secara otomatis dibuka di Twitter dan Slack.

## Cara menggunakan

#### Impor

Ada beberapa cara berbeda untuk mengimpor kode ke Karbon:

- Drag dan jatuhkan dari pengedit teks anda
- Tambahkan ID inti GitHub ke URL (contoh. [`carbon.now.sh/<gist_id_goes_here>`](https://carbon.now.sh/3208813b324d82a9ebd197e4b1c3bae8))
- Atau anda bisa langsung mengetik nya!

#### Kustomisasi

Setelah Anda mendapatkan semua kode Anda menjadi Karbon, Anda dapat menyesuaikan gambar Anda dengan mengubah tema kode, warna latar belakang, tema jendela, padding, bayangan, tulisan, dan banyak lagi.

#### Mengekspor & Membagikan

Setelah Anda menyesuaikan gambar Anda, Anda dapat membagikan potongan gambar anda dalam beberapa cara

##### Buat cuplikan yang disimpan
